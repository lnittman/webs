...
import { ArrowRight, MagnifyingGlass, SignIn, X, Plus } from "@phosphor-icons/react";
import Link from "next/link";
import { Button } from "@repo/design/components/ui/button";
import { useChats } from "@/src/store/data/chat";
import { useAtom } from "jotai";
import { commandMenuOpenAtom } from "@/src/store/ui/layout";
