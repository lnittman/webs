...
import { themeAtom, settingsModalOpenAtom } from "@/lib/store/settingsStore";
                ...
                >
                  ...
                  >
                    ...
                    <DropdownMenuPrimitive.Sub>
                      ...
                      >
                        <Translate className="w-4 h-4 mr-2 text-muted-foreground" weight="duotone" />
                        <span className="flex-1">language</span>
                        <CaretRight className="w-4 h-4 ml-2 text-muted-foreground" weight="duotone" />
                      </DropdownMenuPrimitive.SubTrigger>
                      <AnimatePresence>
